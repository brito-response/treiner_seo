import { Info, Users2Icon } from "lucide-react";
      ...
      <div className="max-w-4xl mx-auto px-6 py-12">
        <header className="mb-10">
          <div className="flex items-start gap-2">
            ...
            <div>
              <h1 className="text-3xl font-semibold">Criar nova Parceria</h1>
              <p className="mt-1 text-muted-foreground max-w-3xl">
                Preencha as informações abaixo para criar uma nova parceria para o  blog.
