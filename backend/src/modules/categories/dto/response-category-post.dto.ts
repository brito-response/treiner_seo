...
import { ResponsePostDto } from "src/modules/posts/dto";

@Exclude()
export class ResponseCategoryWithPostsDto {
    ...
    @ApiPropertyOptional({ type: [ResponsePostDto], description: 'Posts relacionados à categoria'})
    @Expose()
